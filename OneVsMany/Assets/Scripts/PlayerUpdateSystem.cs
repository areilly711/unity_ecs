    ...
    public class PlayerUpdateSystem : JobComponentSystem
    {
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                jobHandle.Complete();
                Translation player = GetComponentDataFromEntity<Translation>(true)[GameHandler.playerEntity];
            ...
            if (isPlayerAliveQuery.CalculateLength() == 0)
            {
            ...
            {
                // still alive, update health
                Entity player = isPlayerAliveQuery.GetSingletonEntity();
                Health health = GetComponentDataFromEntity<Health>()[player];
                hud.SetHealth(health.curr);
            }
